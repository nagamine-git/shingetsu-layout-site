...
| セクション | 内容 | レンダリング |
|-----------|------|------------|
| Hero | タグライン「ローマ字の 1.7 倍効率を、たった 30 キーで。」（根拠: 統一ベンチマーク推定時間 QWERTY 3.195 → 新月 1.887 = 1.69 倍。直下に「※推定値」とベンチ記事への導線を置く）+ メインビジュアル (SVG)。「最高効率」等の最上級は統一ベンチマークで支持されないため使わない（2026-09-25） | prerender |
